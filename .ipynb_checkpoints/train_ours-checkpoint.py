...
if __name__ == "__main__":
    ...
    meta_params = {
        ...
        'pnorm': args.pnorm_init,
    }
    print("Initialize pnorm as {:.2f}".format(meta_params['pnorm']))
    ...
    output_name = "seed={:d}_M={:d}_pinit={:f}".format(hparams['seed'], num_models, args.pnorm_init)
    results = {
        ...
        'pnorm': best_meta_params['pnorm'],
    }
    output_path = os.path.join('train_results', 'pnorm_test', output_name + '.pkl')
    with open(output_path, 'wb') as file:
        pickle.dump(results, file)

    end = time.time()
    print("Meta-training completes with p-norm chosen as {:.2f}".format(best_meta_params['pnorm']))
